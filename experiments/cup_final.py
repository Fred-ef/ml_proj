...
Steps (GUIDA §3.1, §1.5):
    1. Report final MEE on Training / Validation / Internal Test (mandatory).
    2. Retrain the chosen model on all training data.
    3. Predict on the 1000 blind-test patterns.
    4. Write ``<team-name>_ML-CUP25-TS.csv`` with the EXACT required format:
...
DOUBLE-CHECK the CSV format against the Moodle template before delivery.

To be implemented in F6.
"""
